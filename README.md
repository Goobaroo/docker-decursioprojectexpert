# [The Decursio Project - Expert-r1.0.9](https://www.curseforge.com/minecraft/modpacks/decursio-project) on Curseforge
...
The docker on first run will download the same version as tagged of `The Decursio Project - Expert-r1.0.9` and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "The Decursio Project - Expert-r1.0.9 Server Powered by Docker"
* LEVEL world
